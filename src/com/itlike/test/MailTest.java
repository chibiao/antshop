...
public class MailTest {
    ...
    public MimeMessage createSimpleMail(Session session) throws Exception {
        ...
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("1992999264@qq.com"));
        // "954028010@qq.com"));
        // 邮件的标题
        ...
        message.setContent(
                "<h1>购物天堂商城官方激活邮件!点下面链接完成激活操作!</h1><h3><a href='http://antshop.vipgz1.idcfengye.com?code="
